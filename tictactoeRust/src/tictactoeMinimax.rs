...
impl TicTacToe {
    ...
    pub fn minimax(&mut self, depth: i32, is_maximizer: bool, ai_xo: &str, player_xo: &str) -> i32 {
        ...
        if is_maximizer {
            ...
            for coord in coords {
                if self.board[&coord] == " " {
                    ...
                    let score = self.minimax(depth + 1, false, ai_xo, player_xo);
            ...
            for coord in coords {
                if self.board[&coord] == " " {
                    ...
                    let score = self.minimax(depth + 1, true, ai_xo, player_xo);
                    self.board.insert(coord, " ".to_string());
    ...
    pub fn calculate_move_mini(&mut self, ai_xo: &str, player_xo: &str) -> i32 {
        let mut best_score = i32::MIN;
        let mut best_move = -1;
        ...
        for coord in coords {
            if self.board[&coord] == " " {
                self.board.insert(coord, ai_xo.to_string());
                let score = self.minimax(0, false, ai_xo, player_xo);
                self.board.insert(coord, " ".to_string());
                if score > best_score {
                    best_score = score;
                    best_move = coord;
    ...
    pub fn play_game_minimax(&mut self) {
